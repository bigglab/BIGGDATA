...
Revision ID: fe6fad71c7d
Revises: None
Create Date: 2016-04-26 10:29:48.659887

"""

# revision identifiers, used by Alembic.
revision = 'fe6fad71c7d'
down_revision = None
...
def upgrade():
    ...
    sa.Column('root_path', sa.String(length=256), nullable=True),
    sa.Column('old_dropbox_path', sa.String(length=256), nullable=True),
    sa.Column('old_scratch_path', sa.String(length=256), nullable=True),
    ...
    sa.Column('status_string', sa.String(length=256), nullable=True),
    sa.Column('status_flag', sa.Integer(), nullable=True),
    ...
    sa.Column('chain_types_sequenced', postgresql.ARRAY(sa.String(length=20)), nullable=True),
    sa.Column('owners_of_experiment', postgresql.ARRAY(sa.String(length=20)), nullable=True),
    sa.Column('read_access', postgresql.ARRAY(sa.String(length=50)), nullable=True),
    sa.Column('cell_types_sequenced', postgresql.ARRAY(sa.String(length=50)), nullable=True),
    sa.Column('isotypes_sequenced', postgresql.ARRAY(sa.String(length=10)), nullable=True),
    sa.Column('publications', postgresql.ARRAY(sa.String(length=256)), nullable=True),
    sa.Column('mid_tag', postgresql.ARRAY(sa.String(length=256)), nullable=True),
    sa.Column('filenames', postgresql.ARRAY(sa.String(length=256)), nullable=True),
    ...
    sa.Column('cell_markers_used', postgresql.ARRAY(sa.String(length=100)), nullable=True),
    sa.Column('list_of_polymerases_used', postgresql.ARRAY(sa.String(length=100)), nullable=True),
    sa.Column('primer_set_name', postgresql.ARRAY(sa.String(length=100)), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('cell_types_sequenced', postgresql.ARRAY(sa.String(length=50)), nullable=True),
    sa.Column('chain_types_sequenced', postgresql.ARRAY(sa.String(length=20)), nullable=True),
    sa.Column('primary_data_files_ids', postgresql.ARRAY(sa.Integer()), nullable=True),
    ...
    sa.Column('commands', postgresql.ARRAY(sa.String(length=1024)), nullable=True),
    sa.Column('responses', postgresql.ARRAY(sa.Integer()), nullable=True),
    sa.Column('files_to_analyze', postgresql.ARRAY(sa.Integer()), nullable=True),

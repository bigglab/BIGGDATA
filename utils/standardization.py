...
"Query_Start": np.float64, 
"Query_End": np.float64, 
"Codon_Frame": np.float64, 
...
"VGENE: Query_Start": np.float64, 
"VGENE: Query_End": np.float64, 
...
"VGENE: Germline_Start": np.float64, 
"VGENE: Germline_End": np.float64, 
"JGENE: Query_Start": np.float64, 
"JGENE: Query_End": np.float64, 
"JGENE: Germline_Start": np.float64, 
"JGENE: Germline_End": np.float64, 
